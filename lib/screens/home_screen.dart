...
import 'package:skpye_clone/screens/pageviews/chat_list_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: PageView(
        ...
        physics: NeverScrollableScrollPhysics(),//comment the line if you want to have scrolling of the screens
      ),
